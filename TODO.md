...
- Add mindmap or flow (using ReactFlow) view: A visual representation of the relationships between different security events, sources, and targets, allowing analysts to quickly identify potential attack paths and connections between events that may not be immediately obvious in a traditional timeline or list view.
